...
Arguments:
    ...
    provider_version    The version of the AzureRM provider (e.g. v2.72.0)
EOF
}
...
main() {
    ...
    mkdir -p "$provider_dir/internal/tools"
    ...
    go get github.com/magodo/tfadd/schema/legacy
    go mod vendor || die "failed to run go mod vendor"
    out=$(go run "./internal/tools/generate-provider-schema/main.go") || die "failed to generate provider schema"
